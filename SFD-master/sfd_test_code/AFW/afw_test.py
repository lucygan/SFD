...
count = 0
Path = '/home/ganlei/Downloads/SFD/datasets/AFW/testimages/'
f = open('./SFD-master/sfd_test_code/AFW/sfd_afw_dets.txt', 'wt')
for Name in open('./SFD-master/sfd_test_code/AFW/afw_img_list.txt'):
